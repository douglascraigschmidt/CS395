...
public class VideoFileManager {
    ...
    // The VideoFileManager.get() method should be used to obtain an
    // instance
    ...
    /**
     * This method returns true if the specified Video has binary data
    ...
    /**
     * This method copies the binary data for the given video to the
     * provided output stream. The caller is responsible for ensuring
     * that the specified Video has binary data associated with it. If
     * not, this method will throw a FileNotFoundException.
     * 
     * @param v 
     * @param out
     * @throws IOException 
    ...
    public void copyVideoData(Video v, OutputStream out) throws IOException {
        // Taking in client data like this and storing it on disk
        // requires a ton of care that isn't present here. Don't use
        // this is an example of what would be safe in a production
        // application.
        Path source = getVideoPath(v);
    ...
    /**
     * This method reads all of the data in the provided InputStream
     * and stores it on the file system. The data is associated with
     * the Video object that is provided by the caller.
     * 
     * @param v
     * @param videoData
     * @throws IOException
