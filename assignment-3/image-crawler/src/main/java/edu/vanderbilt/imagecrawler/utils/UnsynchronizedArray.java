...
public class UnsynchronizedArray<E> implements Array<E> {
    ...
    public int indexOf(Object o) {
        ...
        if (o == null) {
            ...
            // return IntStream.range(0, mSize).filter
            //  (i -> o.equals(mElementData[i])).findFirst().orElse(-1);
    ...
    public boolean addAll(Collection<? extends E> c) {
        ...
        // Allocate the complete array.
        ensureCapacityInternal(mSize + c.size());

        // Copy the contents of c.toArray() into mElementData.
        System.arraycopy(c.toArray(), 0, mElementData, mSize, c.size());
        mSize += c.size();

        // Did the size change?
        return c.size() > 0;
        // SOLUTION-END return false;
    }
    ...
    public boolean addAll(Array<E> a) {
        ...
        // Copy the contents of a.mElementData into mElementData.
        System.arraycopy(a.uncheckedToArray(), 0, mElementData, mSize, a.size());
        mSize += a.size();
    ...
    public class ArrayIterator implements Iterator<E> {
        ...
        public void remove() {
            ...
            UnsynchronizedArray.this.remove(mLastRet);
            mPos = mLastRet;
            mLastRet = -1;
            // SOLUTION-END
        }
