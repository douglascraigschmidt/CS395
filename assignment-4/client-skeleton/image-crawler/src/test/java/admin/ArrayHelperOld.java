...
public class ArrayHelperOld {
     ...
     */
    public static Object[] getElements(List list) {
     ...
     * of the private Object[] field "mElementData".
     */
    public static void setElements(List array, Object[] elements) throws IllegalAccessException {
     ...
     */
    public static int getSize(List array) {
     ...
     * of the private Object[] field "mElementData".
     */
    public static void setSize(List array, int size) throws IllegalAccessException {
        ReflectionHelper.injectValueIntoMatchingField(
     ...
     * Helper that compares contents of two arrays for sameness (== operator).
     */
    public static void assertArrayEquals(List<Object> expected, List<Object> array) {
